...
$('#welcomeText').html(`<br><br> Hello ${currentUser.uname}! <br>Welcome to your To-Do List`);
...
const promiseCall=()=>{
    alertPromise().then((data)=>{
        alert(`Congrats ${currentUser.uname}! ${data} Tasks have been Successfully Completed !`);
    })
    .catch((err)=>{
